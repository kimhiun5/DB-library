...
<?
$sql_page_list = "SELECT * FROM db_books_booking WHERE is_ok = '1' AND booking_date > '$mysqltime'";
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                ...
                <tbody>
					...
					$sql_member_list = "SELECT * FROM db_member WHERE id = $rec_page_list[member_id]";
                    ...
                    <tr>
                        ...
                        <td><?php echo $rec_page_list[booking_date]; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
