...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="index.php" class="sidebar-title">
            <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide">도서관리 - <strong>관리자</strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
    ...
    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
        <div class="text-center">
            <small>Crafted with by 강현석,김겸용,김현</small><br>
            <small>&copy; <?php echo $template['name'] . ' ' . $template['version']; ?></small>
        </div>
    </div>
